...
class gui:
    ...
    def chatScreen(self, name):
        ...
        self.header = Label(self.window, bg="#222452", fg="white",
        ...
        self.textBox = Text(self.window, width=20, height=2, bg="#222452",
                            fg="white", font=("monospace", 15), padx=5, pady=5)
        self.textBox.place(relwidth=1, relheight=0.745, rely=0.08)

        self.buttonName = Label(self.window, bg="grey", height=80)
        self.buttonName.place(relwidth=1, rely=0.825)

        self.textMsg = Entry(self.buttonName, bg="#34354a",
        ...
        self.buttonMsg = Button(self.buttonName, text="send button", font=(
            "monospace", 15), width=20, bg="grey", fg="white", command=lambda: self.sendData(self.textMsg.get()))
